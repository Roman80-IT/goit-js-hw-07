...
//*    Змінили рядок створення зображень, додавши атрибут loading="lazy".
...
//* Цей обробник просто відмінює стандартну дію посилань і ініціалізує бібліотеку SimpleLightbox, передаючи посилання як аргумент.
//*    Після цього ми ініціалізуємо SimpleLightbox, використовуючи його класичний селектор ".gallery a".
//* Це залишає легковагий інстанс бібліотеки в змінній lightbox, який можемо використовувати для подальших маніпуляцій з галереєю.
